...
import com.afrimkeyboard.inputmethod.latin.common.UnicodeSurrogate;
import com.afrimkeyboard.inputmethod.latin.settings.SpacingAndPunctuations;
import com.afrimkeyboard.inputmethod.latin.utils.CapsModeUtils;
import com.afrimkeyboard.inputmethod.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.afrimkeyboard.inputmethod.latin.common.Constants.UnicodeSurrogate
