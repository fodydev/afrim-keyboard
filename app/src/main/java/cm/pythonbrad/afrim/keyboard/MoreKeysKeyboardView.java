...
public class MoreKeysKeyboardView extends KeyboardView implements MoreKeysPanel {
  ...
  public MoreKeysKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    final TypedArray moreKeysKeyboardViewAttr =
        context.obtainStyledAttributes(
            attrs, R.styleable.MoreKeysKeyboardView, defStyle, R.style.MoreKeysKeyboardView);
    moreKeysKeyboardViewAttr.recycle();
    mKeyDetector =
        new MoreKeysDetector(
            getResources().getDimension(R.dimen.config_more_keys_keyboard_slide_allowance));
  }
  ...
  public void showMoreKeysPanel(
    ...
    final int y =
        pointY - container.getMeasuredHeight() + container.getPaddingBottom() + getPaddingBottom();
  ...
  protected void onKeyInput(final Key key) {
    ...
    if (code == Constants.CODE_OUTPUT_TEXT) {
      ...
      mListener.onCodeInput(
          code, Constants.NOT_A_COORDINATE, Constants.NOT_A_COORDINATE, false /* isKeyRepeat */);
    }
  }
