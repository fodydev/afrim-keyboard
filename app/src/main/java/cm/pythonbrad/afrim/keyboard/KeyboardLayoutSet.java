...
import cm.pythonbrad.afrim.keyboard.internal.UniqueKeysCache;
 ...
 * specific to a keyboard state, such as alphabet, symbols, and so on. Layouts in the same {@link
 * KeyboardLayoutSet} are related to each other. A {@link KeyboardLayoutSet} needs to be created for
 * each {@link android.view.inputmethod.EditorInfo}.
 */
public final class KeyboardLayoutSet {
  ...
  public Keyboard getKeyboard(final int baseKeyboardLayoutSetElementId) {
    ...
    ElementParams elementParams =
        mParams.mKeyboardLayoutSetElementIdToParamsMap.get(keyboardLayoutSetElementId);
  ...
  public static final class Builder {
    ...
    public Builder setSubtype(final Subtype subtype) {
      ...
      mParams.mKeyboardLayoutSetName =
          KEYBOARD_LAYOUT_SET_RESOURCE_PREFIX + subtype.getKeyboardLayoutSet();
      return this;
    }
    ...
    private void parseKeyboardLayoutSetElement(final XmlPullParser parser)
        throws XmlPullParserException, IOException {
      final TypedArray a =
          mResources.obtainAttributes(
              Xml.asAttributeSet(parser), R.styleable.KeyboardLayoutSet_Element);
      try {
        XmlParseUtils.checkAttributeExists(
            a,
            R.styleable.KeyboardLayoutSet_Element_elementName,
            "elementName",
            TAG_ELEMENT,
            parser);
        XmlParseUtils.checkAttributeExists(
            a,
            R.styleable.KeyboardLayoutSet_Element_elementKeyboard,
            "elementKeyboard",
            TAG_ELEMENT,
            parser);
        ...
        elementParams.mKeyboardXmlId =
            a.getResourceId(R.styleable.KeyboardLayoutSet_Element_elementKeyboard, 0);
        elementParams.mAllowRedundantMoreKeys =
            a.getBoolean(R.styleable.KeyboardLayoutSet_Element_allowRedundantMoreKeys, true);
