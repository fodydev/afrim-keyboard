...
public class Keyboard {
  ...
  public Keyboard(final KeyboardParams params) {
    ...
    mProximityInfo =
        new ProximityInfo(
            params.mGridWidth, params.mGridHeight, mOccupiedWidth, mOccupiedHeight, mSortedKeys);
  }

  /**
   * Return the sorted list of keys of this keyboard. The keys are sorted from top-left to
   * bottom-right order. The list may contain {@link Key.Spacer} object as well.
   *
   ...
   * @return the list of the nearest keys to the given point. If the given point is out of range,
   *     then an array of size zero is returned.
   */
