...
public interface MoreKeysPanel {
   ...
   * @param listener the listener that will receive keyboard action from this {@link MoreKeysPanel}.
   */
  // TODO: Currently the MoreKeysPanel is inside a container view that is added to the parent.
  // Consider the afrimr approach of placing the MoreKeysPanel itself into the parent view.
  void showMoreKeysPanel(
      View parentView,
  ...
  /**
   * Dismisses the more keys panel and calls the controller's onDismissMoreKeysPanel to remove the
   * panel's container view.
   */
  ...
  /**
   * Translate X-coordinate of touch event to the local X-coordinate of this {@link MoreKeysPanel}.
   *
  ...
  /**
   * Translate Y-coordinate of touch event to the local Y-coordinate of this {@link MoreKeysPanel}.
   *
