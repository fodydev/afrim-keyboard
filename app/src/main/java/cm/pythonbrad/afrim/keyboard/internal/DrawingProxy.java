...
import cm.pythonbrad.afrim.keyboard.MoreKeysPanel;
...
public interface DrawingProxy {
   ...
   *
   * @param fadeInOrOut {@link #FADE_IN} starts while-typing-fade-in animation. {@link #FADE_OUT}
   *     starts while-typing-fade-out animation.
   */
