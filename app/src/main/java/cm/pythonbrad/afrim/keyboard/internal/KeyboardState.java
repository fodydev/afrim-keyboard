 ...
 *
 * <p>This class contains all keyboard state transition logic.
 *
 * <p>The input events are {@link #onLoadKeyboard(int, int)}, {@link #onSaveKeyboardState()}, {@link
 * #onPressKey(int,boolean,int,int)}, {@link #onReleaseKey(int,boolean,int,int)}, {@link
 * #onEvent(Event,int,int)}, {@link #onFinishSlidingInput(int,int)}, {@link
 * #onUpdateShiftState(int,int)}, {@link #onResetKeyboardStateToAlphabet(int,int)}.
 *
 * <p>The actions are {@link SwitchActions}'s methods.
 */
public final class KeyboardState {
  ...
  public void onSaveKeyboardState() {
    ...
    if (mIsAlphabetMode) {
      ...
      state.mShiftMode =
          mAlphabetShiftState.isAutomaticShifted()
              ? AUTOMATIC_SHIFT
  ...
  private void setShiftLocked(final boolean shiftLocked) {
    ...
    if (!mIsAlphabetMode) return;
    if (shiftLocked
        && (!mAlphabetShiftState.isShiftLocked() || mAlphabetShiftState.isShiftLockShifted())) {
  ...
  private void onPressSymbol(final int autoCapsFlags, final int recapitalizeMode) {
  ...
  private void onReleaseSymbol(
      final boolean withSliding, final int autoCapsFlags, final int recapitalizeMode) {
  ...
  // TODO: Remove this method. Come up with a more comprehensive way to reset the keyboard layout
  // when a keyboard layout set doesn't get reloaded in LatinIME.onStartInputViewInternal().
  public void onResetKeyboardStateToAlphabet(final int autoCapsFlags, final int recapitalizeMode) {
    if (DEBUG_EVENT) {
      Log.d(
          TAG, "onResetKeyboardStateToAlphabet: " + stateToString(autoCapsFlags, recapitalizeMode));
    }
    ...
    switch (mSwitchState) {
      ...
      case SWITCH_STATE_SYMBOL_BEGIN:
        if (!isSpaceOrEnter(code)
            && (Constants.isLetterCode(code) || code == Constants.CODE_OUTPUT_TEXT)) {
  ...
  public String toString() {
    return "[keyboard="
        ...
        + mSymbolKeyState
        + " switch="
        + switchStateToString(mSwitchState)
        + "]";
  }
