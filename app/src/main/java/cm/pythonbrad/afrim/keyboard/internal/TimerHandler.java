...
public final class TimerHandler extends LeakGuardHandlerWrapper<DrawingProxy>
  ...
  public void startKeyRepeatTimerOf(
      final PointerTracker tracker, final int repeatCount, final int delay) {
  ...
  public void startLongPressTimerOf(final PointerTracker tracker, final int delay) {
    ...
    final int messageId =
        (key.getCode() == Constants.CODE_SHIFT) ? MSG_LONGPRESS_SHIFT_KEY : MSG_LONGPRESS_KEY;
  ...
  public void startDoubleTapShiftKeyTimer() {
    sendMessageDelayed(
        obtainMessage(MSG_DOUBLE_TAP_SHIFT_KEY), ViewConfiguration.getDoubleTapTimeout());
  }
