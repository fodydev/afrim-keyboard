...
import static cm.pythonbrad.afrim.latin.settings.SingleLanguageSettingsFragment.LOCALE_BUNDLE_KEY;
...
import cm.pythonbrad.afrim.compat.MenuItemIconColorCompat;
...
public final class LanguagesSettingsFragment extends PreferenceFragment {
  ...
  public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
    ...
    MenuItemIconColorCompat.matchMenuIconColor(
        mView, addLanguageMenuItem, getActivity().getActionBar());
    MenuItem removeLanguageMenuItem = menu.findItem(R.id.action_remove_language);
    MenuItemIconColorCompat.matchMenuIconColor(
        mView, removeLanguageMenuItem, getActivity().getActionBar());
  }
      ...
      if (DEBUG_SUBTYPE_ID) {
        Log.d(
            ...
            String.format(
                ...
                subtype.getLocale(), subtype.hashCode(), subtype.hashCode(), subtype.getName()));
      }
