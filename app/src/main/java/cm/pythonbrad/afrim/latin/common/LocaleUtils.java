...
package cm.pythonbrad.afrim.latin.common;
 ...
 *
 * <p>This file has the same meaning and features (and shares all of its code) with the one with the
 * same name in Latin IME. They need to be kept synchronized; for any update/bugfix to this file,
 * consider also updating/fixing the version in Latin IME.
 */
public final class LocaleUtils {
  ...
  public static Locale constructLocaleFromString(final String localeString) {
    synchronized (sLocaleCache) {
      ...
      if (elements.length == 1) {
        ...
        locale =
            new Locale(
                elements[0] /* language */, elements[1] /* country */, elements[2] /* variant */);
      }
  ...
  /**
   * Get the closest matching locale. This searches by: 1. {@link Locale#equals(Object)} 2.
   * Language, Country, and Variant match 3. Language and Country match 4. Language matches
   *
   * @param localeToMatch the locale to match.
   * @param options a collection of locales to find the best match.
   * @return the locale from the collection that is the best match for the specified locale or null
   *     if nothing matches.
   */
  public static Locale findBestLocale(
      final Locale localeToMatch, final Collection<Locale> options) {
  ...
  /** Comparator for {@link Locale} to order them alphabetically first. */
