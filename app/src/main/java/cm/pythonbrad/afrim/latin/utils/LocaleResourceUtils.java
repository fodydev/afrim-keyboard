...
public final class LocaleResourceUtils {
  ...
  private static void initLocked(final Context context) {
    ...
    final String[] exceptionalLocaleInRootLocale =
        res.getStringArray(R.array.locale_displayed_in_root_locale);
  ...
  /**
   * Get the full display name of the locale in the system's locale. For example in an English
   * system, en_US: "English (US)", fr_CA: "French (Canada)"
   *
   * @param localeString the locale to display.
   * @return the full display name of the locale.
   */
  public static String getLocaleDisplayNameInSystemLocale(final String localeString) {
  ...
  /**
   * Get the full display name of the locale in its locale. For example, en_US: "English (US)",
  ...
  /**
   * Get the display name of the language in the system's locale. For example in an English system,
   * en_US: "English", fr_CA: "French"
   *
   * @param localeString the locale to display.
   * @return the display name of the language.
   */
  public static String getLanguageDisplayNameInSystemLocale(final String localeString) {
    final Locale displayLocale = sResources.getConfiguration().locale;
  ...
  /**
   * Get the display name of the language in its locale. For example, en_US: "English", fr_CA:
   * "Français"
   *
   * @param localeString the locale to display.
   * @return the display name of the language.
  ...
  private static String getLocaleDisplayNameInternal(
      final String localeString, final Locale displayLocale) {
