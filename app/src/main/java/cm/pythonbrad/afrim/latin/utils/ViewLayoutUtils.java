...
public final class ViewLayoutUtils {
  ...
  public static MarginLayoutParams newLayoutParam(
      final ViewGroup placer, final int width, final int height) {
  ...
  public static void placeViewAt(
      final View view, final int x, final int y, final int w, final int h) {
