...
public final class DebugLogUtils {
  private static final String TAG = DebugLogUtils.class.getSimpleName();
  private static final boolean sDBG = DebugFlags.DEBUG_ENABLED;
   ...
   *
   * <p>This sends all arguments to the log, separated by spaces. Any null argument is converted to
   * the "null" string. It uses a very visible tag and log level for debugging purposes.
   *
   ...
   *
   * <p>This does the same as #l but prints in red
   *
   * @param args the stuff to send to the log
   */
