...
/**
 * Emojis are supplementary characters expressed as a low+high pair. For instance, the emoji U+1F625
 * is encoded as "\uD83D\uDE25" in UTF-16, where '\uD83D' is in the range of [0xd800, 0xdbff] and
 * '\uDE25' is in the range of [0xdc00, 0xdfff]. {@see
