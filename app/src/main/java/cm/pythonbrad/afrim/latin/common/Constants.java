...
public final class Constants {
  ...
  public static final class TextUtils {
     ...
     * characters. This value may be used with {@link android.text.TextUtils#CAP_MODE_CHARACTERS},
     * {@link android.text.TextUtils#CAP_MODE_WORDS}, and {@link
  ...
  /**
   * Custom request code used in {@link
   * cm.pythonbrad.afrim.keyboard.KeyboardActionListener#onCustomRequest(int)}.
   */
  ...
  /**
   * Special keys code. Must be negative. These should be aligned with constants in {@link
   * cm.pythonbrad.afrim.keyboard.internal.KeyboardCodesSet}.
   */
  ...
  /**
   * Screen metrics (a.k.a. Device form factor) constants of {@link
   * cm.pythonbrad.afrim.R.integer#config_screen_metrics}.
   */
